...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/opsgility/AzureStack-VM-PoC/master/scripts/Install-ASDK.ps1" -OutFile "C:\AzureStackonAzureVM\Install-ASDK.ps1"
